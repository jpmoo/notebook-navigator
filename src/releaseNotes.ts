...
const RELEASE_NOTES: ReleaseNote[] = [
    {
        ...
        date: '2026-06-05',
        showOnUpdate: true,
        info: 'This version adds two fantastic new features: Open folder notes in right sidebar, and open related folder notes. When these are enabled, clicking on a note will now automatically open the closest folder note in the right sidebar! Super useful for scratch pads related to different areas of your vault. This release also have dozens of ==list pane and navigation pane performance improvements==. Notebook Navigator now does less work when scrolling and moving through notes, folders, tags and properties. Give it a try and let me know if you notice any difference!',
        new: [
            ...
            '**Settings.** New setting ==Right sidebar: Open related folder notes==. When a note opens, the right sidebar opens the nearest ancestor folder note. Very useful for shared "scratch pads" related to the notes youare editing.',
