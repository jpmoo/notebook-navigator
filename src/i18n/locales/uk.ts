...
export const STRINGS_UK = {
    ...
    settings: {
        ...
        pageDescriptions: {
            ...
            appearanceBehavior: 'Шаблони, поведінка, навігація з клавіатури, кнопки миші, вигляд і форматування.',
            ...
            fileOperations: 'Підтвердження видалення, вкладення та поведінка при конфлікті переміщення файлів.',
        ...
        items: {
            ...
            calendarCustomFilePattern: {
                ...
                desc: 'Формат шляху з використанням формату дати Moment. Беріть назви підпапок у квадратні дужки, напр. [Work]/YYYY. Натисніть на іконку шаблону, щоб задати шаблон. Вкажіть розташування теки шаблонів у Вигляд і поведінка > Шаблони.',
            ...
            showNearestFolderNoteInSidebar: {
                name: 'Права бічна панель: Відкривати пов’язані нотатки папок',
                desc: 'Коли відкривається нотатка, права бічна панель відкриває найближчу батьківську нотатку папки.'
            },
            confirmBeforeDelete: {
