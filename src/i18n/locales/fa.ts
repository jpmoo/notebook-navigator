...
export const STRINGS_FA = {
    ...
    settings: {
        ...
        pageDescriptions: {
            ...
            appearanceBehavior: 'الگوها، رفتار، پیمایش با صفحه‌کلید، دکمه‌های ماوس، ظاهر و قالب‌بندی.',
            ...
            fileOperations: 'تأییدیه‌های حذف، پیوست‌ها و رفتار تعارض در جابجایی فایل.',
        ...
        items: {
            ...
            calendarCustomFilePattern: {
                ...
                desc: 'قالب‌بندی مسیر با استفاده از فرمت تاریخ Moment. نام زیرپوشه‌ها را در کروشه قرار دهید، مثال [Work]/YYYY. روی نماد قالب کلیک کنید تا قالب تنظیم شود. محل پوشه الگوها را در ظاهر و رفتار > الگوها تنظیم کنید.',
            ...
            showNearestFolderNoteInSidebar: {
                name: 'نوار کناری راست: باز کردن یادداشت‌های پوشه مرتبط',
                desc: 'وقتی یادداشتی باز می‌شود، نوار کناری راست نزدیک‌ترین یادداشت پوشه والد را باز می‌کند.'
            },
            confirmBeforeDelete: {
