    ...
    settings: {
        ...
        items: {
            ...
            showNearestFolderNoteInSidebar: {
                name: 'Правая боковая панель: открывать связанные заметки папок',
                desc: 'Когда открывается заметка, правая боковая панель открывает ближайшую родительскую заметку папки.'
            },
            confirmBeforeDelete: {
