    ...
    settings: {
        ...
        items: {
            ...
            showColorsInShortcutsOnly: {
                name: 'Показывать цвета только в ярлыках',
                desc: 'При включении пользовательские цвета фона и текста для папок и тегов отображаются только в области ярлыков. При отключении цвета также отображаются в дереве навигации ниже.'
            },
            collapseBehavior: {
